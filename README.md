...
[Multi-surface test](app/src/main/java/com/android/grafika/MultiSurfaceActivity.java).  Simple activity with three overlapping SurfaceViews, one marked secure.
